        ...
        Public Sub WriteValue(value As Object) Implements IJsonWriter.WriteValue
            ...
            Else
                ...
                ElseIf type.IsEnum Then
                    If JWT.PetaJson.Enumerable.Any(Of Object)(type.GetCustomAttributes(GetType(FlagsAttribute), False)) Then
	...
	Public Class ReflectionInfo
		...
		Public Shared Function GetReflectionInfo(type As Type) As ReflectionInfo
            Return ReflectionInfo._cache.[Get](type, Function()
                                                         ...
                                                         Dim typeMarked As Boolean = JWT.PetaJson.Enumerable.Any(Of JsonAttribute)(JWT.PetaJson.Enumerable.OfType(Of JsonAttribute)(type.GetCustomAttributes(GetType(JsonAttribute), True)))
                                                         ...
                                                         Dim anyFieldsMarked As Boolean = allMembers.Any(Function(x As MemberInfo) JWT.PetaJson.Enumerable.Any(Of JsonAttribute)(JWT.PetaJson.Enumerable.OfType(Of JsonAttribute)(x.GetCustomAttributes(GetType(JsonAttribute), False))))
                                                         ...
                                                         Return ReflectionInfo.CreateReflectionInfo(type, Function(mi As MemberInfo)
                                                                                                              ...
                                                                                                              If JWT.PetaJson.Enumerable.Any(Of Object)(mi.GetCustomAttributes(GetType(JsonExcludeAttribute), False)) Then
                                                                                                                  result = Nothing
                                                                                                              Else
                                                                                                                  Dim attr As JsonAttribute = JWT.PetaJson.Enumerable.FirstOrDefault(Of JsonAttribute)(JWT.PetaJson.Enumerable.OfType(Of JsonAttribute)(mi.GetCustomAttributes(GetType(JsonAttribute), False)))
		...
		Public Shared Function CreateReflectionInfo(type As Type, callback As ReadCallback_t(Of MemberInfo, JsonMemberInfo)) As ReflectionInfo
            ...
            If Not JWT.PetaJson.Enumerable.Any(Of JsonMemberInfo)(members) Then
                result = Nothing
            Else
                    ...
                    Else
                        result = Me.ReadLiteral(Function(literal As Object)
                                                    ...
                                                    Catch ex_16 As Exception
                                                        Dim attr As Object = JWT.PetaJson.Enumerable.FirstOrDefault(Of Object)(type.GetCustomAttributes(GetType(JsonUnknownAttribute), False))
