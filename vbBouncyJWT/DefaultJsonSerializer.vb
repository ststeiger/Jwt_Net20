...
Namespace BouncyJWT
    ...
    Public Class DefaultJsonSerializer
        ...
        Function Serialize(obj As Object) As String Implements IJsonSerializer.Serialize
            ' Return Nothing
        ...
        Function Deserialize(Of T)(json As String) As T Implements IJsonSerializer.Deserialize
            ' Return Nothing
